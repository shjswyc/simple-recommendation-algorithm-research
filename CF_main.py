        ...
        for i in range(0, len(userId)):
            ...
            if KNN_K <= len(recommend_items):
                for j in range(0, KNN_K):
                    ...
                    # print(recommend_items[j][0])
                    # print(recommend_items[j][1])
                    # print(rating_train[SN])
                    # print(train_rating[SN])
